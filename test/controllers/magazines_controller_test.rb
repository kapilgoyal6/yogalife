...
class MagazinesControllerTest < ActionController::TestCase
  ...
  test "should create magazine" do
    assert_difference('Magazine.count') do
      post :create, magazine: { cover_image: @magazine.cover_image, desc: @magazine.desc, issue_date: @magazine.issue_date, pages: @magazine.pages, title: @magazine.title }
    end
  ...
  test "should update magazine" do
    patch :update, id: @magazine, magazine: { cover_image: @magazine.cover_image, desc: @magazine.desc, issue_date: @magazine.issue_date, pages: @magazine.pages, title: @magazine.title }
    assert_redirected_to magazine_path(assigns(:magazine))
  end
